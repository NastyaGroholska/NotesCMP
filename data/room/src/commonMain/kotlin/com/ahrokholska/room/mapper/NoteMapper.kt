...
import com.ahrokholska.room.data.intermediate.GoalsNoteDetails
import com.ahrokholska.room.data.intermediate.GuidanceNoteDetails
...
import com.ahrokholska.room.data.intermediate.TaskAndSubtask

internal fun Note.InterestingIdea.toEntity() =
    InterestingIdeaNoteEntity(
        id = id,
        title = title,
        body = body
    )
