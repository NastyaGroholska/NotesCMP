...
import notescmp.feature.notes_home.generated.resources.notes
    ...
    NotesGrid(
        ...
        topBar = {
            TopBarWithTitle(
                ...
                title = stringResource(type.title) + " " + stringResource(Res.string.notes),
                onBackClick = onBackClick
            )
        }
    ) {
...
@Composable
internal fun AllNotesScreenPreview() {
    AllNotesScreenContent(
